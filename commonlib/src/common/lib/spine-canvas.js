...
(function (spine) {
	var AssetManager = (function () {
		function AssetManager(canvas, textureLoader, pathPrefix, downloader) {
    ...
    AssetManager.prototype.createImage = function () {
      let ret
      // #ifdef H5
      ret = new Image();
      // #endif
	...
	var Downloader = (function () {
      ...
      uni.request({
        ...
        success: (res)=>{
          _this.finish(url, res.statusCode, res.data);
        },
        fail: (res)=>{
          _this.finish(url, res.statusCode, res.data);
        }
...
(function (spine) {
	...
	(function (canvas) {
		var AssetManager = (function (_super) {
			...
			function AssetManager(canvas, pathPrefix, downloader) {
				if (pathPrefix === void 0) { pathPrefix = ""; }
				if (downloader === void 0) { downloader = null; }
				return _super.call(this, canvas, function (image) { return new spine.canvas.CanvasTexture(image); }, pathPrefix, downloader) || this;
			}
			return AssetManager;
		}(spine.AssetManager));
